...
export type CoupleCMSPage = 'overview' | 'details' | 'content' | 'home' | 'schedule' | 'story' | 'moments' | 'rsvps' | 'getting-there' | 'wishes' | 'faqs' | 'features' | 'guests' | 'analytics' | 'audit' | 'sharing';
