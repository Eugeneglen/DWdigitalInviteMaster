...
export type CoupleCMSPage = 'overview' | 'details' | 'content' | 'images' | 'home' | 'schedule' | 'story' | 'moments' | 'rsvps' | 'getting-there' | 'wishes' | 'faqs' | 'features' | 'guests' | 'analytics' | 'audit' | 'sharing';
