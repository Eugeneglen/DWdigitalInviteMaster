...
const FIELDS = [
  { key: 'title', label: 'Section Title', type: 'text' as const, placeholder: 'e.g. Moments' },
  { key: 'subtitle', label: 'Section Subtitle', type: 'text' as const, placeholder: 'e.g. Captured memories along the way' },
];
