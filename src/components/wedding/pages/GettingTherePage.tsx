            ...
            <div className="col-span-2 space-y-8 py-4">
              ...
              <div className="border-t border-champagne-silk/30 pt-8 space-y-4">
                ...
                <div className="relative rounded-lg overflow-hidden border border-charcoal-ink/10">
                  <iframe
                    src="https://maps.google.com/maps?q=The+Singapore+EDITION+38+Cuscaden+Road+Singapore+249731&t=&z=16&ie=UTF8&iwloc=&output=embed"
                    width="100%"
                    height="280"
                    style={{ border: 0 }}
                    allowFullScreen
                    ...
                    title="The Singapore EDITION Location"
                    className="w-full"
                  />
                  <a
                    href="https://www.google.com/maps/search/The+Singapore+EDITION+38+Cuscaden+Road+Singapore+249731"
                    target="_blank"
